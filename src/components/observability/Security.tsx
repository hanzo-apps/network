...
const Security = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-neutral-800/10 via-transparent to-transparent opacity-70"></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-neutral-500/20 to-neutral-500/20 rounded-xl blur opacity-75"></div>
            <div className="relative bg-[var(--black)] rounded-xl border border-gray-800 p-8">
              <div className="space-y-6">
                <div className="flex items-center">
                  <div className="p-2 bg-neutral-800/30 rounded-md mr-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-24 h-2 bg-gray-700 rounded-full overflow-hidden">
                        <div className="w-5/6 h-full bg-neutral-500"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
