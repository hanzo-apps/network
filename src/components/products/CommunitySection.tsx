...
/** Every entry renders the same way: one icon contract, className and all. */
type IconProps = { className?: string };

const iconMap: Record<CommunityLink["type"], React.ComponentType<IconProps>> = {
