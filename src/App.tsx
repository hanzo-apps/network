...
%cDecentralized AI Compute Infrastructure
Join the future of distributed computing.

%cWe're hiring! Reach out about working with us:
%chttps://hanzo.network/careers
%cnetwork@hanzo.ai

%c– Hanzo Network (Powered by Hanzo AI)
`,
  'font-size: 24px; font-weight: bold; color: #06b6d4;',
  'font-size: 14px; color: #888;',
  'font-size: 14px; color: #fff;',
  'font-size: 14px; color: #06b6d4; text-decoration: underline;',
